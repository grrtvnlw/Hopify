...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    return await queryInterface.bulkInsert('Breweries', [
      {
    ...
    },
    {
      ...
      image: 'https://assets-global.website-files.com/5dd2bab4d8e6f2cf71c78e4e/5e1f364f0263e77216ad5a55_Hopsecutioner%20copy.png',
    ...
    {
      name: 'Elusory',    
      description: 'Triple dry-hopped hazy IPA loaded with juicy Mosaic hops floating on a bold combination of classic American hops.',    
      link: 'https://www.orpheusbrewing.com/beers/elusory/',
      image: 'https://www.orpheusbrewing.com/wp-content/uploads/2020/02/Elusory-Can-Transparent-2.png',
    ...
    },
    {
      ...
      description: 'A German-style pilsner with all German hops and featuring heritage German Barke Pilsner malt, Choosers of the Slain is refreshingly dry and bitter with a delicate, spicy hop nose and a touch of citrus. The Barke Pilsner malt gives a bready, crackery undertone to keep everything in balance glass after glass.',    
      link: 'https://www.orpheusbrewing.com/beers/choosers-of-the-slain-2/',
      image: 'https://www.orpheusbrewing.com/wp-content/uploads/2019/07/WebCan_ChoosersoftheSlain.png',
      brewery: 'Orpheus Brewing',
      breweryLink: 'https://www.orpheusbrewing.com/',
      city: 'Atlanta',
      abv: '4.8%',    
    ...
    },
    {
      ...
      image: 'https://s3.amazonaws.com/anchor_cms_production/beers/1/original/Steam_CanBottlePint_v2.png?1530025176',
    ...
    },
    {
      ...
      description: 'A wheat beer brewed with orange peel for a subtle sweetness and bright, citrus aroma.',    
      link: 'https://www.bluemoonbrewingcompany.com/currently-available/blue-moon-belgian-white',
      image: 'https://www.bluemoonbrewingcompany.com/sites/bluemoon/files/styles/beers/public/beers/2018-06/BlueMoon-BelgianWhite.png?itok=AonO8W6_',
    ...
    }, 
    {
      ...
      image: 'https://images.ctfassets.net/lwrxrme3djuw/7An77AhOSEReR3PCCbMfLQ/0bdd9284f3966f09ac4ba0d2474a095e/Beer_Images-Vliet_Alexander_Bohn_2018_Square.jpg?w=1200',
    ...
    },
    {
      ...
      image: 'https://i1.wp.com/mondaynightbrewing.com/wp-content/uploads/2017/09/BOBP-for-website-01-01-01-01-01.png?resize=1632%2C1632&ssl=1',
      brewery: 'Monday Night Brewing',
      breweryLink: 'https://mondaynightbrewing.com/',
      city: 'Atlanta',
      abv: '7.4%',    
    ...
    },
    {
      ...
      image: 'https://ballastpoint.com/wp-content/uploads/2018/05/12_Sculpin-2.png',
